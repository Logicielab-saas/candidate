...
interface EditProjectDialogProps {
  ...
  onSubmit: (id: string, values: Omit<Project, "id">) => void;
  project: Project;
}
...
export function EditProjectDialog({
  ...
  useEffect(() => {
    if (project) {
      ...
      const startDate = parse(project.startDate, "MMMM yyyy", new Date(), {
        locale: fr,
      });
  ...
  const handleSubmit = (values: ProjectFormValues) => {
    ...
    onSubmit(project.id, formattedValues);
    onOpenChange(false);
    toast({
      variant: "success",
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Ex: Projet de développement d'une application de gestion de contenu"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
