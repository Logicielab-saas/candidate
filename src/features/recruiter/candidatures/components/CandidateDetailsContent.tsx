...
export function CandidateDetailsContent({
  ...
  return (
    <div className="flex-1 p-6 bg-background rounded-lg border">
      ...
      <div>
        ...
        <div className="text-sm text-muted-foreground">
          Aucune Q/R n&apos;a été et ne pourra être configurée pour cette offre
          d&apos;emploi car aucun questionnaire n&apos;a été sélectionné.
        </div>
      </div>
