...
interface ReprogramLeftSideProps {
  onSubmit: (data: FormValues) => Promise<void>;
}

export function ReprogramLeftSide({ onSubmit }: ReprogramLeftSideProps) {
    ...
    <div className="flex gap-6">
      <ScrollArea className="max-h-[760px]">
        <form
          ...
          className="w-[400px] shrink-0 space-y-6 pr-6"
        >
      ...
      <div className="flex-1">
        <div className="relative">
          <div
            ...
            className="h-[750px] overflow-y-auto scrollbar-thin scrollbar-thumb-zinc-200 scrollbar-track-transparent hover:scrollbar-thumb-zinc-300"
          >
            <CalendarView
