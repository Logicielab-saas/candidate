...
interface EntretienTabsProps {
  activeTab: "Entretiens" | "Disponibilites";
  onTabChange: (_value: "Entretiens" | "Disponibilites") => void;
  className?: string;
}

export function EntretienTabs({
  activeTab,
  onTabChange,
  className,
}: EntretienTabsProps) {
  return (
    <div className={cn("w-full", className)}>
      <Tabs
        value={activeTab}
        onValueChange={(value) =>
          onTabChange(value as "Entretiens" | "Disponibilites")
        }
      >
